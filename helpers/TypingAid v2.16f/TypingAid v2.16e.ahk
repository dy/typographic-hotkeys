...
IfEqual, ArrowKeyMethod, Off
{
   ...
   Hotkey, $PgDn, Off
         ...
         EnabledKeyboardHotKeys .= "$Up"
         EnabledKeyboardHotKeys .= "$Down"
         EnabledKeyboardHotKeys .= "$PgUp"
         EnabledKeyboardHotKeys .= "$PgDn"
         If DisabledAutoCompleteKeys contains E
            Hotkey, $^Enter, Off
         else EnabledKeyboardHotKeys .= "$^Enter"
         If DisabledAutoCompleteKeys contains S
            HotKey, $^Space, Off
         else EnabledKeyboardHotKeys .= "$^Space"
         If DisabledAutoCompleteKeys contains T
            HotKey, $Tab, Off
         else EnabledKeyboardHotKeys .= "$Tab"
         If DisabledAutoCompleteKeys contains R
            HotKey, $Right, Off
         else EnabledKeyboardHotKeys .= "$Right"
      }
...
EnableKeyboardHotKeys()
{
   ...
   Loop, Parse, EnabledKeyboardHotKeys, 
   {
