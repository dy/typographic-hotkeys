...
; Tests: habr texts, gmail en texts, my wordpress texts, Netbeans texts, Photoshop texts, 
...
uUnit["ru"] := "К|Гц|Н|Дж|Вт|Па|Кл|В|Ом|Ф|Вб|Тл|Гн|См|Бк|Гр|Зв|Нп" ;there is only unique units. There is no Amper, B, H, T, and other symmetric for both cases units.
uUnit["en"] := "K|Hz|N|J|W|Pa|C|V|Ω|F|Wb|S|Bq|Gy|Sv|Np"
...
mathRules.item("i)(" . numPatt . ")[" . space . "]?([" . pow . "]+)?[" . space . "]?(" . unitPrefix ")?((" . uunit["ru"] . "|" . uunit["en"] . ")[" . space . "]?([" . pow . "]+)?)(?=[" . space . newline . punct . "]|$)") := "$1$2 $3$T5$6" ;prefixed upper units

mathRules.item("i)(" . numPatt . ")[" . space . "]?([" . pow . "]+)?[" . space . "]?(" . unitPrefix ")?((" . lunit["ru"] . "|" . lunit["en"] . ")[" . space . "]?([" . pow . "]+)?)(?=[" . space . newline . punct . "]|$)") := "$1$2 $3$L5$6" ;prefixed lower units
